...
public class Upload extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse servletResponse)
        ...
        try {
            ...
            if (method.equals("OPTIONS")) {
                ...
                log.debug("will use HeadHandler");
            ...
            log.error("tus exception", texc);
            response.setStatus(texc.getStatus()).setHeader("FailedReason", texc.getText());
        } catch (Throwable e) {
            ...
            response.setStatus(500).setHeader("FailedReason", msg);
        }
    ...
    private void checkVersion(HttpServletRequest request, Response response)
        ...
        if (!request.getMethod().equals("OPTIONS")
            ...
            response.setHeader("FailedReason", "Unsupported version:" + clientVersion);
